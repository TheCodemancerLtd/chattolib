...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SERVERDISCOVERYSERVICE']._serialized_start=256
  _globals['_SERVERDISCOVERYSERVICE']._serialized_end=377
